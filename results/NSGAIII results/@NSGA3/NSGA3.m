classdef NSGA3
    ...
    properties (SetAccess = private)
        ...
        pop;                      %population 
        empty_individual;
        solutionStruct;             % the structure of solution 
    end
    methods
        function nsga3 = NSGA3(VarSize,nDivision,numberOfSolutions,numberOfObjectives, ...
                numberOfIterations,lowerBounds,upperBounds,pCrossover,pMutation,mutationRate,solutionStruct)
            nsga3.solutionStruct=solutionStruct;
